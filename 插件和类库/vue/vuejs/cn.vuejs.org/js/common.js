(function () {
  ...
  function initHashLevelRedirects() {
    ...
    checkForHashRedirect(/components\.html$/, {
      ...
      '使用组件': 'https://cn.vuejs.org/v2/guide/components-registration.html',
      ...
      '非父子组件的通信': 'https://cn.vuejs.org/v2/guide/state-management.html',
      ...
      '杂项': 'https://cn.vuejs.org/v2/guide/components-edge-cases.html',
  ...
  function initApiSpecLinks () {
    var apiContent = document.querySelector('https://cn.vuejs.org/js/.content.api')
    if (apiContent) {
